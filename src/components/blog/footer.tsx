  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-xl space-y-2 px-1 py-4 sm:px-1.5 lg:space-y-4 lg:px-2">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          {/* <ul className="mt-8 flex justify-start gap-6 sm:mt-0 sm:justify-end">
            {socialMedia.map(({ link, title, icon }) => (
              <li key={link}>
                <a href={link} rel="noopener" target="_blank" title={title}>
                  {icon}
                </a>
              </li>
            ))}
        ...
        <div className="grid grid-cols-1 gap-2 gap-y-3.5 border-t border-gray-100 pt-2 sm:grid-cols-2 lg:grid-cols-4 lg:pt-4">
          <div>
            <p className="font-medium text-gray-900">الرياض</p>

            <ul className="mt-1.5 space-y-1 text-sm">
              <li>
                <a
                  href="https://mabet.com.sa/ar/units?q=&type=&area=1&city=&"
                  target="_blank"
                  rel="noopener"
          ...
          <div>
            <p className="font-medium text-gray-900">جدة</p>

            <ul className="mt-1.5 space-y-1 text-sm">
              <li>
                <a
                  href="https://mabet.com.sa/ar/units?q=&type=&area=12&"
                  target="_blank"
                  rel="noopener"
                  className="text-gray-700 transition hover:opacity-75"
                >
          ...
          <div>
            <p className="font-medium text-gray-900">الطايف</p>
          ...
          <div>
            <p className="font-medium text-gray-900">مزارع</p>

            <ul className="mt-1.5 space-y-1 text-sm">
              <li>
                <a
                  href="https://mabet.page.link/Hcuz"
                  target="_blank"
                  rel="noopener"
                  className="text-gray-700 transition hover:opacity-75"
                >
                  مزرعه للايجار في جده
                </a>
              </li>
          ...
          <div>
            <p className="font-medium text-gray-900">أخرى</p>

            <ul className="mt-1.5 space-y-1 text-sm">
              <li>
                <a
                  href="https://mabet.page.link/Y8fa"
                  target="_blank"
                  rel="noopener"
                  className="text-gray-700 transition hover:opacity-75"
                >
                  شاليهات في درة العروس
                </a>
              </li>
              ...
              <li>
                <a
                  ...
                  className="text-gray-700 transition hover:opacity-75"
                >
                  شاليه البرادايس في جده
                </a>
              </li>
            </ul>
          </div>
          <div>
            <p className="font-medium text-gray-900">تطبيق مبيت</p>

            <ul className="mt-1.5 space-y-1 text-sm">
              <li>
                <a
                  href="https://apps.apple.com/sa/app/%D9%85%D9%80%D8%A8%D9%80%D9%8A%D8%AA/id6449609458?l=ar"
                  target="_blank"
                  rel="noopener"
                  className="text-gray-700 transition hover:opacity-75"
                >
        ...
        <p className="text-xs text-gray-500">
          &copy; {new Date().getFullYear()}. Mabet. All rights reserved.
        </p>
      </div>
    </footer>
  )
