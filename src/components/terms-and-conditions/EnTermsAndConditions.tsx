      ...
      <div className="container rounded-3xl border py-5 leading-loose shadow-lg lg:!px-6 lg:py-10">
        <div className="mb-6 lg:mb-8">
          ...
          <p className="mb-3 lg:mb-6">
            Welcome to
            <span className="highlight preview_website_name">Mabet</span>!
          </p>
          <p>
          ...
          <p>
            ...
            <span className="highlight preview_website_name">Mabet</span> if you
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p>
            ...
            <span className="highlight preview_website_name">Mabet</span>, you
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p>
            ...
            material on
            <span className="highlight preview_website_name">Mabet</span>. All
            intellectual property rights are reserved. You may access this from
            <span className="highlight preview_website_name">Mabet</span> for
...
export default EnTermsAndConditions
