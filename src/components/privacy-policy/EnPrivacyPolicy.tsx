    ...
    <main className="py-10 text-[14px] lg:py-20 lg:text-[16px]">
      <div className="container rounded-3xl border py-5 leading-loose shadow-lg lg:!px-6 lg:py-10">
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p>
            Welcome to <b> Mabet</b>.
          </p>
          <p>
            <b>Mabet</b> (“us”, “we”, or “our”) operates <b>mabet.com.sa</b>{" "}
            (hereinafter referred to as <b>“Service”</b>).
          </p>
          <p>
            Our Privacy Policy governs your visit to <b>mabet.com.sa</b>, and
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p>
            <b>SERVICE</b> means the mabet.com.sa website operated by Mabet.
          </p>
          <p>
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p>Mabet uses the collected data for various purposes:</p>
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p>
            If you are located outside Kingdom of Saudi Arabia and choose to
            provide information to us, please note that we transfer the data,
            including Personal Data, to Kingdom of Saudi Arabia and process it
            there.
          </p>
          <p>
          ...
          <p>
            Mabet will take all the steps reasonably necessary to ensure that
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p>
            ...
            us at <b>support@mabet.com.sa</b>.
          </p>
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p>
            ...
            please send your request(s) by email: <b>support@mabet.com.sa</b>.
          </p>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            us by email: <b>support@mabet.com.sa</b>.
          </p>
        </div>
      </div>
    </main>
